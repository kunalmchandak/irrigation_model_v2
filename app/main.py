...
import joblib
model = joblib.load("model/water_predictor_model_v2.pkl")
...
def fetch_weather(city):
    ...
    return {
        ...
        "pressure":  d["main"]["pressure"] / 10,       # hPa → kPa
...
def predict_and_schedule(city, crop_type, crop_stage, soil_type="loamy"):
...
def predict(
    ...
    return predict_and_schedule(city, crop_type, crop_stage, soil_type)
